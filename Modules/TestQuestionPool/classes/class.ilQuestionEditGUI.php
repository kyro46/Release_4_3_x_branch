...
* @version  $Id: class.ilQuestionEditGUI.php 34181 2012-04-16 07:56:29Z bheyser $
*
...
* @ilCtrl_Calls ilQuestionEditGUI: assErrorTextGUI, assOrderingHorizontalGUI, assTextSubsetGUI
*
...
//var_dump($parameters);
	...
	*/
	function setQuestionId($a_questionid)
	{
	...
	*/
	function setPoolRefId($a_poolrefid)
	{
//echo "<br>Setting Pool Ref ID:".$a_poolrefid;
	...
	*/
	function setPoolObjId($a_poolobjid)
	{
