...
class ShibAuth extends Auth {
	 ...
	 * @param bool $add
	 *
	 * @internal  param \obj_id $integer of role (role_id)
	 * @internal  param \ref_id $integer of role folder (ref_id)
	 *
	 ...
	 * @param A $string
	 *
	 * @internal param \A $string Shibboleth attribute or other string
	 *
	 * @return string First value of attribute
	 */
	private static function getFirstString($string) {
		$list = explode(';', $string);
