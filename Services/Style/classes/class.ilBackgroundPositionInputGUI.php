...
class ilBackgroundPositionInputGUI extends ilFormPropertyGUI
{
	...
	*/
	function setHorizontalValue($a_horizontalvalue)
	{
	...
	*/
	function setVerticalValue($a_verticalvalue)
	{
